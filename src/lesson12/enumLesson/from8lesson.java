...
public class from8lesson {
    public static void main(String[] args) throws WrongInputConsoleParametersException, IllegalAccessException {
        System.out.println("Please, write your month.");
        Scanner console = new Scanner(System.in);
        String month = console.nextLine();
        List<Months> months = new ArrayList<>(List.of(Months.values()));
        List<Seasons> seasons = new ArrayList<>(List.of(Seasons.values()));
